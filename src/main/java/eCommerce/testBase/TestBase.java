...
import eCommerce.excelReader.ExcelReader;

public class TestBase 
{
	public static WebDriver driver;
	public Properties OR, OR1, OR2;
	public File f1, f2, image;
	public FileInputStream file1, file2;
	public static ExtentReports extent;
	public static ExtentTest test;
	public ITestResult result;
	public ExcelReader exReader;
	
	static
	{
		Calendar calendar = Calendar.getInstance();
		SimpleDateFormat formater = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss");
		extent = new ExtentReports(System.getProperty("user.dir")+"/src/main/java/eCommerce/report"+ formater.format(calendar.getTime())+ ".html", false);
	}
	...
	{
		OR= new Properties();
		f1 = new File(System.getProperty("user.dir")+"/src/main/java/eCommerce/config/LoginPage.properties");
		file1 = new FileInputStream(f1);
		OR.load(file1);
		/*
		OR2 = new Properties();
		f2 = new File(System.getProperty("user.dir")+"/src/main/java/eCommerce/config/or.properties");
	...
	public String getScreenShot(String imageName) throws IOException
	{
		...
		String imageLocation = System.getProperty("user.dir")+"/src/main/java/eCommerce/screenshot";
		 Calendar  calendar = Calendar.getInstance();
		 SimpleDateFormat formatter = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss");
		 String actualImageName = imageLocation + imageName + formatter.format(calendar.getTime())+".png";
	...
	public void implictedWait(long time)
	{
	...
	@BeforeMethod()
	public void beforeMeothod(Method result)
	{
	...
	public String[][] getData(String excelName, String sheetName)
	{
		...
		String excelLocation = System.getProperty("user.dir") + "/src/main/java/eCommerce/data/" + excelName;
		return exReader.getExcelData(excelLocation, sheetName);		
	}
